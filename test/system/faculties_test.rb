...
class FacultiesTest < ApplicationSystemTestCase
  ...
  test "should create faculty" do
    ...
    fill_in "Academic background", with: @faculty.academic_background
    fill_in "Areas of interest", with: @faculty.areas_of_interest
    fill_in "Date of joining", with: @faculty.date_of_joining
    fill_in "Designation", with: @faculty.designation
    fill_in "Dp", with: @faculty.dp
    fill_in "Name", with: @faculty.name
    fill_in "Professional experience", with: @faculty.professional_experience
    fill_in "Remarks", with: @faculty.remarks
    fill_in "Visits abroad", with: @faculty.visits_abroad
